...
<main class="main">
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('products.show',$featuredProduct->slug) }}">
                                                <img class="default-img" src="/storage/products/{{ $featuredProduct->image }}" alt="">
                                                <img class="hover-img" src="/storage/products/{{ $featuredProduct->image }}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $featuredProduct->category->name }}</a>
                                        </div>
                                        <h2><a href="shop-product-right.html">{{ $featuredProduct->name }}</a></h2>
                        ...
                        @foreach($popularProducts as $popularProduct)
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/storage/products/{{ $popularProduct->image }}" alt="">
                                                <img class="hover-img" src="/storage/products/{{ $popularProduct->image }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $popularProduct->category->name }}</a>
                                        </div>
                                        <h2><a href="{{ route('products.show',$popularProduct->slug) }}">{{ $popularProduct->name }}</a></h2>
                                        <div class="rating-result" title="90%">
                                        <span>
                                            <span>90%</span>
                                        </span>
                            ...
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="/storage/products/{{ $newProduct->image }}" alt="">
                                                <img class="hover-img" src="/storage/products/{{ $newProduct->image }}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $newProduct->category->name }}</a>
                                        </div>
                                        <h2><a href="shop-product-right.html">{{ $newProduct->name }}</a></h2>
                                        <div class="rating-result" title="90%">
                                        <span>
                                            <span>90%</span>
                                        </span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0" style="background-image: url('{{ asset('front/assets') }}/imgs/banner/menu-banner-7.jpg');">
                        <div class="deal-top">
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated" style="background-image: url('{{ asset('front/assets') }}/imgs/banner/menu-banner-8.jpg');">
                        <div class="deal-top">
    ...
    <section class="mb-50">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="banner-bg wow fadeIn animated" style="background-image: url('{{ asset('front/assets') }}/imgs/banner/banner-8.jpg')">
