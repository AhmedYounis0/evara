                ...
                <div class="header-nav d-none d-lg-flex">
                    <div class="main-categori-wrap d-none d-lg-block">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-large">
                            <ul>
                                @foreach($megaCategories as $value)
                                    <li class="has-children">
                                        <a href="shop-grid-right.html"><i class="evara-font-dress"></i>{{ $value->name }}</a>
                                                    ...
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                ...
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">{{ $childCategory->name }}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </li>
                                                    </ul>
...
{{--                            <div class="more_categories">Show more...</div>--}}
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                <li>
                                    <a class="active" href="{{ route('theme.home') }}">Home</a>
                                </li>
                                <li>
                                    ...
                                    <ul class="mega-menu">
                                        @foreach($megaCategories as $value)
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">{{ $value->name }}</a>
                                                <ul>
                                                    @foreach($value->children as $childCategory)
                                                        <li>
